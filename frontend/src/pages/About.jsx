...
//           <span className="text-gold-500 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Our Story</span>
//           <h1 className="text-4xl md:text-5xl font-serif text-stone-900">About The Venue</h1>
//         </div>
        
//         {page ? (
//           <div className="card-premium p-8 md:p-12 animate-fade-in-up delay-100">
//             {page.bannerImage && (
//               <div className="relative overflow-hidden rounded-sm mb-10 shadow-lg">
//                 <img
//                   src={`http://localhost:5000${page.bannerImage}`}
//                   alt={page.title}
//                   className="w-full h-80 md:h-96 object-cover transform hover:scale-105 transition-transform duration-1000"
//                 />
//               </div>
//             )}
//             <div
//               className="prose prose-stone prose-lg max-w-none font-light text-stone-600 leading-loose"
//               dangerouslySetInnerHTML={{ __html: page.content }}
//             />
//           </div>
//         ) : (
//           <div className="card-premium p-8 md:p-12 text-center">
//             <p className="text-stone-600 font-serif text-xl italic mb-8">
//               "Welcome to Marquee Booking, your premier destination for elegant events and unforgettable celebrations."
//             </p>
          ...
          <div className="relative order-2 lg:order-1 animate-fade-in-up delay-100">
            ...
            <div className="relative z-10 overflow-hidden shadow-2xl bg-stone-200">
              <img
                ...
                alt="Venue Interior"
                className="w-full h-[500px] object-cover hover:scale-105 transition-transform duration-1000 ease-out"
              />
            </div>
